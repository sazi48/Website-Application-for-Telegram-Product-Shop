...
products = [
    {'id': 1, 'name': 'АНАНАСОВЫЕ ДОЛЬКИ', 'image': 'Ананасовые дольки.png', 'description': 'Сочные, сладкие кусочки тропического тайского ананаса'},
    {'id': 2, 'name': 'АПЕЛЬСИНОВЫЙ ФРЕШ', 'image': 'Апельсиновый фреш.png', 'description': 'Свежевыжатый апельсиновый сок. Вмеру сладкий с легкой цитрусовой кислинкой'},
    {'id': 3, 'name': 'АРБУЗ-ДЫНЯ', 'image': 'Арбуз-дыня.png', 'description': 'Свежесть сладкого арбуза и бархатистая нежность спелой дыни'},
    {'id': 4, 'name': 'БАНАНОВЫЙ МИЛКШЕЙК', 'image': 'Банановый милкшейк.png', 'description': 'Тот самый молочный коктейль из детства Банановый с молочными нотами и щепоткой ванили'},
    {'id': 5, 'name': 'ВАФЕЛЬНЫЕ ТРУБОЧКИ', 'image': 'Вафельные трубочки.png', 'description': 'Изысканное лакомство мягких вафель и насыщенным, сливочным вкусом ирландского крема'},
    {'id': 6, 'name': 'ВИНОГДАРНАЯ ГАЗИРОВКА', 'image': 'Виноградная газировка.png', 'description': 'Яркий и освежающий вкус газировки с спелым виноградом'},
    {'id': 7, 'name': 'ВИШНЕВЫЙ СОК', 'image': 'Вишневый сок.png', 'description': 'Яркий, натуральный вишневый сок с благородной кислинкой'},
    {'id': 8, 'name': 'ГОРНАЯ ЧЕРНИКА', 'image': 'Горная черника.png', 'description': 'Аромат сочной черники, произрастащей в горных районах. Вкус тонкий, с легкой кислинкой и цветочными нотами'},
    {'id': 9, 'name': 'ГРАНАТОВОЕ ВИНО', 'image': 'Гранатовое вино.png', 'description': 'Это освежающее вино с гранатового-ягодным вкусом'},
